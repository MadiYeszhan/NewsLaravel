                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('news.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="preview" type="text" class="form-control @error('preview') is-invalid @enderror" name="preview" value="{{ old('preview') }}" required autocomplete="preview" autofocus>
                                @error('preview')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
